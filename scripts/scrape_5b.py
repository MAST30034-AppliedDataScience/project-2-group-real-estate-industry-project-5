...
N_PAGES = range(1, 20)  # Number of pages to scrape
BEDROOM_COUNTS = [5]  # Bedroom counts to filter by
...
for bedroom_count in BEDROOM_COUNTS:
    for page in N_PAGES:
        url = BASE_URL + f"/rent/?bedrooms={bedroom_count}-any&state=vic&page={page}"
...
with open('./data/raw/domaindata_new_5.json', 'w') as f:
