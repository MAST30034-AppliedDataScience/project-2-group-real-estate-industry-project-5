...
BEDROOM_COUNTS = [4]  # Bedroom counts to filter by
...
for bedroom_count in BEDROOM_COUNTS:
    for page in N_PAGES:
        url = BASE_URL + f"/rent/?bedrooms={bedroom_count}&state=vic&page={page}"
...
with open('./data/raw/domaindata_new_4.json', 'w') as f:
